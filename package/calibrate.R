...
# Can you actually provide projected versions?

# Make sure projections match up

# When create basis or project, should store variance of each basis vector so don't need to recalculate

# Also should store correct R_W where possible


#' Wrapper for prediction + history matching, for single wave
#'
#' 
#'
#'
...
# given predictions, calculates implausibiltiy
# wrap up with emulator later
